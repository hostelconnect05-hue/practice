...
Fruit colour helps fruits attract animals that eat them and disperse their seeds. A study of 383 tropical plant species in Costa Rica and Peru found that black was the most common fruit colour eaten by birds, followed by red. The study concluded that colourful fruits improve the chances of successful seed dispersal because they are easier for animals to locate.`,
  ...
  },
  {
    ...
    section: "Grammar & Vocabulary",
    question: "Fill in the blank:",
    sentence: "At present, I _______ a great place of historical importance.",
    options: [
      { key: "A", text: "was visiting" },
      { key: "B", text: "had visited" },
      { key: "C", text: "visited" },
  ...
  },
  {
    ...
    options: [
      ...
      { key: "B", text: "No error" },
      { key: "C", text: "to whom I sold" },
      { key: "D", text: "who was sold to" },
  ...
  },
  {
    id: 22,
    section: "Grammar & Vocabulary",
    question: "Choose the correct synonym for 'Consign':",
    options: [
      { key: "A", text: "Dispatch" },
      { key: "B", text: "Spike" },
      { key: "C", text: "Impede" },
    ...
    correctAnswer: "A",
    explanation: "'Consign' means to send, deliver, or dispatch.",
  },
  {
    id: 23,
    section: "Grammar & Vocabulary",
    question: "Choose the correct synonym for 'Imagine':",
    options: [
      { key: "A", text: "Mirage" },
      { key: "B", text: "Apprehend" },
      { key: "C", text: "Flabbergast" },
      { key: "D", text: "Daze" },
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      ...
      { key: "C", text: "to enhance their" },
      { key: "D", text: "to enhanced there" },
      { key: "E", text: "No error" },
    ],
    correctAnswer: "C",
  ...
  },
  {
    ...
    section: "Grammar & Vocabulary",
    question: "Sentence Correction:",
    sentence: "Did you know about the accident when you first went theirs.",
    options: [
      { key: "A", text: "No error" },
      { key: "B", text: "gone there?" },
      { key: "C", text: "went their." },
      { key: "D", text: "went there?" },
      { key: "E", text: "go there" },
    ],
    correctAnswer: "D",
  ...
  },
  {
    ...
    section: "Grammar & Vocabulary",
    question: "Fill in the blank:",
    sentence: "Does your spouse ever agree ______ anything with you?",
    options: [
      { key: "A", text: "towards" },
      { key: "B", text: "onto" },
      { key: "C", text: "of" },
    ...
    correctAnswer: "D",
    explanation: "The standard English idiom is 'agree on' a topic or plan.",
  },
  {
    id: 27,
    section: "Grammar & Vocabulary",
  ...
  },
  {
    ...
    section: "Grammar & Vocabulary",
    question: "Fill in the blank:",
    sentence: "Suddenly the door ______ and a wild animal entered the room.",
    options: [
      { key: "A", text: "Opened" },
      { key: "B", text: "Opening" },
      { key: "C", text: "Open" },
  ...
  },
  {
    id: 30,
    section: "Grammar & Vocabulary",
    question: "Choose the correct antonym of 'Fragile':",
    options: [
      { key: "A", text: "Weak" },
      { key: "B", text: "Delicate" },
      { key: "C", text: "Strong" },
  ...
  },
  {
    ...
    section: "Grammar & Vocabulary",
    question: "Fill in the blank:",
    sentence: "He is good ______ Mathematics.",
    options: [
      { key: "A", text: "in" },
      { key: "B", text: "at" },
      { key: "C", text: "on" },
    ...
    correctAnswer: "B",
    explanation: "The correct preposition for skill in a subject is 'good at'.",
  },
  {
    id: 33,
    section: "Grammar & Vocabulary",
    ...
    options: [
      ...
      { key: "B", text: "Accommodation" },
      { key: "C", text: "Acommodation" },
  ...
  },
  {
    ...
    section: "Grammar & Vocabulary",
    question: "Identify the error in the sentence:",
    sentence: "It was raining heavily, so I weren't commute.",
    options: [
      { key: "A", text: "Weren't" },
      { key: "B", text: "No error" },
      { key: "C", text: "Raining" },
  ...
  },
  {
    ...
    section: "Grammar & Vocabulary",
    question: "Identify the error in the sentence:",
    sentence: "There are the people who I work in the factory.",
    options: [
      { key: "A", text: "the factory" },
      { key: "B", text: "are" },
      { key: "C", text: "These" },
      { key: "D", text: "who" },
      { key: "E", text: "No error" },
