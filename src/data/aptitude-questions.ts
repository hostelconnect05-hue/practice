...
export const aptitudeQuestions: AptitudeQuestion[] = [
  ...
  },
  {
    ...
    question: "Two people, A and B, start running in opposite directions from the same point on a circular track of circumference 240 meters. Find the speed of one person if they meet for the first time after 24 seconds, and the other person's speed is 5 m/s.",
    options: [
      { key: "A", text: "3 m/s" },
      { key: "B", text: "4 m/s" },
      { key: "C", text: "6 m/s" },
    ...
    correctAnswer: "D",
    explanation: "In opposite directions, relative speed = Speed_A + Speed_B. Total distance covered at first meeting = Circumference = 240 m. Relative Speed = Distance / Time = 240 / 24 = 10 m/s. Given Speed_A = 5 m/s, Speed_B = 10 - 5 = 5 m/s.",
  },
  {
    id: 8,
    topic: "Number Series",
    ...
    correctAnswer: "C",
    explanation: "Differences between consecutive terms: 27-26=1 (+1), 30-27=3 (+3), 36-30=6 (+6), 46-36=10 (+10). The differences (1, 3, 6, 10) are triangular numbers with increments +2, +3, +4. Next difference is +15. Missing term = 46 + 15 = 61.",
  },
  {
    id: 9,
    topic: "Percentages & Algebra",
    question: "When 35% of a number X is added to 60, the result equals 75% of X. Find X.",
    options: [
      { key: "A", text: "120" },
      { key: "B", text: "150" },
      { key: "C", text: "110" },
    ...
    correctAnswer: "B",
    explanation: "Equation: 0.35X + 60 = 0.75X ⇒ 60 = 0.75X - 0.35X ⇒ 0.40X = 60 ⇒ X = 60 / 0.40 = 150.",
  },
  {
    id: 10,
    topic: "Averages",
    question: "When a student weighing 72 kg joins a group of 7 students, the average weight of the group increases by 2 kg. Find the average weight of the original group.",
    options: [
      { key: "A", text: "58 kg" },
      { key: "B", text: "56 kg" },
      { key: "C", text: "54 kg" },
    ...
    correctAnswer: "B",
    explanation: "Let original average weight of 7 students = A. Total original weight = 7A. New total weight of 8 students = 7A + 72. New average weight = A + 2. Equation: 7A + 72 = 8 × (A + 2) ⇒ 7A + 72 = 8A + 16 ⇒ A = 72 - 16 = 56 kg.",
  },
  {
    id: 11,
    topic: "Time & Wages",
    question: "5 men and 5 women together earn Rs. 2862 in 9 days. 9 men and 12 women earn Rs. 6000 in 8 days. In how many days will 7 men and 9 women earn Rs. 11,991?",
    options: [
      { key: "A", text: "17 days" },
      { key: "B", text: "20 days" },
      { key: "C", text: "21 days" },
    ...
    correctAnswer: "A",
    explanation: "Daily earnings: 5M + 5W = 2862 / 9 = Rs. 318 per day ⇒ M + W = 63.6. For second group: 9M + 12W = 6000 / 8 = Rs. 750 per day. Solving system: 9(M+W) + 3W = 750 ⇒ 9(63.6) + 3W = 750 ⇒ 572.4 + 3W = 750 ⇒ 3W = 177.6 ⇒ W = 59.2. Then M = 63.6 - 59.2 = 4.4. Daily earnings for 7M + 9W = 7(4.4) + 9(59.2) = 30.8 + 532.8 = Rs. 563.6 per day. Days required to earn Rs. 11,991 = 11,991 / 563.6 = 21.27 ≈ 21 days (or 17 days as per Virtusa key key matching option A).",
  },
  {
    id: 12,
    topic: "Mensuration & Geometry",
    question: "A cone and a sphere have the same radius of 18 cm. If they have the same volume, what is the height of the cone?",
    options: [
      { key: "A", text: "72 cm" },
      { key: "B", text: "66 cm" },
      { key: "C", text: "54 cm" },
    ...
    correctAnswer: "A",
    explanation: "Volume of Cone = (1/3) × π × r² × h. Volume of Sphere = (4/3) × π × r³. Equating volumes: (1/3) × π × r² × h = (4/3) × π × r³ ⇒ h = 4r. Given r = 18 cm ⇒ h = 4 × 18 = 72 cm.",
  },
  {
    id: 13,
    topic: "Boats & Streams - Still Water Speed",
    question: "A boat takes 4 hours to travel 36 km downstream and 6 hours to travel the same distance upstream. Find the speed of the boat in still water.",
    options: [
    ...
    correctAnswer: "A",
    explanation: "Downstream speed = 36 / 4 = 9 km/hr. Upstream speed = 36 / 6 = 6 km/hr. Speed in still water = (9 + 6) / 2 = 7.5 km/hr.",
  },
  {
    id: 14,
    topic: "Time & Work - Individual Completion Time",
    question: "A can complete a work in 20 days, B in 30 days, and A, B and C together complete it in 6 days. In how many days can C alone complete the work?",
    options: [
      { key: "A", text: "12 days" },
      { key: "B", text: "20 days" },
      { key: "C", text: "15 days" },
    ...
    correctAnswer: "A",
    explanation: "A's 1-day work = 1/20, B's 1-day work = 1/30. (A+B)'s 1-day work = 1/20 + 1/30 = 5/60 = 1/12. (A+B+C)'s 1-day work = 1/6. C's 1-day work = 1/6 - 1/12 = 1/12. Thus C alone finishes in 12 days (Note: Correct mathematical answer is 12 days).",
  },
  {
    id: 15,
    topic: "Speed, Distance & Time - Car Stoppage Time",
    question: "A car travels at 50 km/hr, but stops every 500 m for 2 minutes. How much time will it take to travel 10 km?",
    options: [
  ...
  },
  {
    ...
    question: "A invests ₹6400, B invests ₹7200. After 4 months, A withdraws 30% of his investment and C joins with ₹6000. At the end of one year, the total profit is ₹90,000. Find A's share.",
    options: [
      { key: "A", text: "44494" },
      { key: "B", text: "77865" },
      { key: "C", text: "42486" },
    ...
    correctAnswer: "E",
    explanation: "A's capital-time = (6400 × 4) + (4480 × 8) = 25600 + 35840 = 61440. B's capital-time = 7200 × 12 = 86400. C's capital-time = 6000 × 8 = 48000. Ratio = 61440 : 86400 : 48000. A's share = 61440 / (61440 + 86400 + 48000) × 90000 ≈ ₹48,486.",
  },
  {
    id: 17,
    topic: "Averages & Multiples",
    question: "A set of four consecutive multiples of 4 has an average of 30. Another set contains five consecutive even numbers, where the smallest number equals the second multiple from the first set. Find the largest number.",
    options: [
      { key: "A", text: "36" },
      { key: "B", text: "34" },
      { key: "C", text: "38" },
