            ...
            <Card className="border-emerald-500/30 bg-emerald-950/15 backdrop-blur hover:border-emerald-500/60 hover:bg-emerald-950/25 transition">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between gap-3">
                  <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30">
                    Hands-on Coding • 15 Problems
                  </Badge>
                  <span className="text-xs text-emerald-400 font-semibold">15 Algorithmic Coding Questions</span>
                </div>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-300 leading-relaxed">
                  Practice hands-on coding problems from Virtusa technical online assessments including Minimum Length Substring (Full Frequency Match), Reduce the Bill, Count Valid Subarrays, Minimum Length Substring, Social Media Username, Vowel Consonant Rearrange, Frequency Sync, Shopping Cart, Coke Pack Purchase, Index Sort, Minimum Index, and more. Features Monaco code editor, testcase execution, verified 32-bit Java integer constraints, and real-time pass/fail evaluation.
                </p>
                ...
                <div className="inline-flex items-center justify-between gap-3 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition">
                  Open Coding Problems (15 Statements)
