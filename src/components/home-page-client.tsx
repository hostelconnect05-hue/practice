        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-zinc-800 pb-6">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-zinc-400">
              Practice real Virtusa Online Assessment questions including
              Coding, Reading Comprehension, & Verbal Ability.
            </p>
          </div>
          <ThemeToggle />
        </header>
            ...
            <Card className="border-emerald-500/30 bg-emerald-950/15 backdrop-blur hover:border-emerald-500/60 hover:bg-emerald-950/25 transition">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="text-xs text-emerald-400 font-semibold">
                    17 Algorithmic Coding Questions
                  </span>
                </div>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-300 leading-relaxed">
                  Practice hands-on coding problems from Virtusa technical
                  online assessments including Maze of People, Count Subsets
                  (Minimum Subarrays), Minimum Length Substring (Full Frequency
                  Match), Reduce the Bill, Count Valid Subarrays, Minimum Length
                  Substring, Social Media Username, Vowel Consonant Rearrange,
                  Frequency Sync, Shopping Cart, Coke Pack Purchase, Index Sort,
                  Minimum Index, and more. Features Monaco code editor, testcase
                  execution, verified 32-bit Java integer constraints, and
                  real-time pass/fail evaluation.
                </p>
                <div className="flex flex-wrap items-center gap-4 text-xs text-zinc-400 pt-1">
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" />{" "}
                    Real-time Code Execution & Compiler
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" />{" "}
                    Visible & Hidden Test Case Verification
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" />{" "}
                    Java 32-bit Signed Integer Range Verified
                  </span>
                </div>
        ...
        {(activeTab === "all" || activeTab === "rc") && (
          <div className="mb-4">
            <Card className="border-purple-500/30 bg-purple-950/15 backdrop-blur hover:border-purple-500/50 transition">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-300 leading-relaxed">
                  Practice all 10 Reading Comprehension passages from Virtusa
                  OAs (Gift-Giving, Storr Lochs Monster, Oral History &
                  Anthropology, Carbon Dioxide & Climate, Bird Flight Evolution,
                  Body Fat & Cognition, Light Spectrum, Guam Snakes, Coastal
                  Blue-Carbon, Van Gogh & Fruit Colour) with instant right/wrong
                  feedback, detailed passage explanations, score tracking, and
                  reattempts.
                </p>
                <div className="flex flex-wrap items-center gap-4 text-xs text-zinc-400 pt-1">
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-purple-400" />{" "}
                    Full Passages Included
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-purple-400" />{" "}
        ...
        {(activeTab === "all" || activeTab === "verbal") && (
          <div className="mb-6">
            <Card className="border-sky-500/30 bg-sky-950/15 backdrop-blur hover:border-sky-500/50 transition">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-300 leading-relaxed">
                  Practice English grammar, sentence correction, vocabulary
                  synonyms, article selection, and subject-verb agreement with
                  instant feedback, explanations, live scoring, and reattempts.
                </p>
                <div className="flex flex-wrap items-center gap-4 text-xs text-zinc-400 pt-1">
                  <span className="flex items-center gap-1.5">
        ...
        {(activeTab === "all" || (activeTab as string) === "tech") && (
          <div className="mb-6">
            <Card className="border-amber-500/30 bg-amber-950/15 backdrop-blur hover:border-amber-500/50 transition">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-300 leading-relaxed">
                  Practice core Virtusa Technical MCQs across C++,
                  Object-Oriented Programming (OOP), Data Structures (Disjoint
                  Set, Priority Queue, Stack, Linked List, Z Algorithm),
                  Operating Systems (Scheduling, File Allocation, Bootloader,
                  Deadlock), and SQL / DBMS (Joins, Date Functions, Grant
                  Permissions, Triggers, Number Conversions).
                </p>
                <div className="flex flex-wrap items-center gap-4 text-xs text-zinc-400 pt-1">
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-amber-400" /> C++
                    Access Specifiers & OOP
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-amber-400" /> Data
                    Structures & OS Kernels
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-amber-400" /> SQL
                    Queries & Permissions
                  </span>
                </div>
        ...
        {(activeTab === "all" || (activeTab as string) === "aptitude") && (
          <div className="mb-6">
            <Card className="border-orange-500/30 bg-orange-950/15 backdrop-blur hover:border-orange-500/50 transition">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="text-xs text-orange-400 font-semibold">
                    20 Verified Aptitude Questions
                  </span>
                </div>
                <CardTitle className="text-xl font-bold text-zinc-50 mt-2">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-300 leading-relaxed">
                  Practice mathematical problem solving on work & production
                  rates, profit & loss percentages, successive discounts &
                  marked prices, girl-to-boy weight ratio averages,
                  speed-time-distance ratios, boats & streams, partnerships, and
                  multi-person work completion times.
                </p>
                <div className="flex flex-wrap items-center gap-4 text-xs text-zinc-400 pt-1">
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-orange-400" />{" "}
                    Mathematically Verified Answers
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-orange-400" />{" "}
        ...
        {(activeTab === "all" || (activeTab as string) === "analytical") && (
          <div className="mb-6">
            <Card className="border-pink-500/30 bg-pink-950/15 backdrop-blur hover:border-pink-500/50 transition">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="text-xs text-pink-400 font-semibold">
                    22 Verified Analytical Questions
                  </span>
                </div>
                <CardTitle className="text-xl font-bold text-zinc-50 mt-2">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-300 leading-relaxed">
                  Practice logical and analytical reasoning on row seating
                  arrangements, letter-word coding-decoding, blood relation
                  family trees, queue order & ranking, and logical syllogism
                  conclusions.
                </p>
                <div className="flex flex-wrap items-center gap-4 text-xs text-zinc-400 pt-1">
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-pink-400" />{" "}
                    Linear Seating & Position Mapping
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-pink-400" /> Word
                    Coding & Pattern Deduction
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5 text-pink-400" />{" "}
                    Family Trees & Syllogism Rules
                  </span>
                </div>
